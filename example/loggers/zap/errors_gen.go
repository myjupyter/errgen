...
func (e *InternalError) LogValue() slog.Value {
	return slog.GroupValue(
		...
		slog.Any("stringField", e.StringField),
		slog.Any("int64Field", e.Int64Field),
		slog.Any("intField", e.IntField),
		slog.Any("uint64Field", e.Uint64Field),
		slog.Any("float64Field", e.Float64Field),
		slog.Any("boolField", e.BoolField),
		slog.Any("timeField", e.TimeField),
		slog.Any("durationField", e.DurationField),
