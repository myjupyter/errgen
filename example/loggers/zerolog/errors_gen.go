...
func (e *InternalError) MarshalZerologObject(event *zerolog.Event) {
	event.Str("error", e.Error())
	event.Str("stringField", e.StringField)
	event.Int64("int64Field", e.Int64Field)
	event.Int("intField", e.IntField)
	event.Uint64("uint64Field", e.Uint64Field)
	event.Uint("uintField", e.UintField)
	event.Uint64("uintptrField", uint64(e.UintptrField))
	event.Float64("float64Field", e.Float64Field)
	event.Bool("boolField", e.BoolField)
	event.Time("timeField", e.TimeField)
	event.Dur("durationField", e.DurationField)
	event.Interface("intSliceField", e.IntSliceField)
	event.Interface("objectSliceField", e.ObjectSliceField)
	event.Interface("mapType", e.MapType)
}
...
// MarshalZerologObject implements [zerolog.LogObjectMarshaler] for zerolog structured logging
func (e *EntityNotFoundError) MarshalZerologObject(event *zerolog.Event) {
	event.Str("error", e.Error())
	event.Str("entityType", e.EntityType)
	event.Int("iD", e.ID)
}
