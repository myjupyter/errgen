...
// LogrusFields returns the error fields as [logrus.Fields] for use with logrus,
// e.g. log.WithFields(e.LogrusFields()).Error("...")
func (e *InternalError) LogrusFields() logrus.Fields {
	fields := logrus.Fields{
		"error":            e.Error(),
		"stringField":      e.StringField,
		"int64Field":       e.Int64Field,
		"intField":         e.IntField,
		"uint64Field":      e.Uint64Field,
		"uintField":        e.UintField,
		"uintptrField":     e.UintptrField,
		"float64Field":     e.Float64Field,
		"boolField":        e.BoolField,
		"timeField":        e.TimeField,
		"durationField":    e.DurationField,
		"intSliceField":    e.IntSliceField,
		"objectSliceField": e.ObjectSliceField,
		"mapType":          e.MapType,
	}
	return fields
}
...
// LogrusFields returns the error fields as [logrus.Fields] for use with logrus,
// e.g. log.WithFields(e.LogrusFields()).Error("...")
func (e *EntityNotFoundError) LogrusFields() logrus.Fields {
	fields := logrus.Fields{
		"error":      e.Error(),
